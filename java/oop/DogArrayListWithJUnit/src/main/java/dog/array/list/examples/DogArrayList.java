package dog.array.list.examples;
...
public class DogArrayList {
	...
	public static void main(String[] args) {
		...
		System.out.println("Print out shadowCopyDogs: ");
		dogArrayList.printDog(shallowCopyDogs);
		
		System.out.println("checking to see if you make a shallow copy");
		// if you change the value in the original object
		// it would also change the value in shallow copy object 
		...
		System.out.println("checking to see if you make a deep copy");
		Dog bob = dogs.get(1);
		bob.setName("Bob Bob");
		System.out.println("Print out dogs:");

...
public class SampleHashTable {
	...
	public static void main(String[] args) {
		...
		if (hashT1.containsKey(10)) {
			System.out.println("the key is already associated with a value");
		}
		...
		// notice key "Pen" exists already, the value for "Pen" does NOT change 
		hashT2.computeIfAbsent("Pen", k -> 43.22);
